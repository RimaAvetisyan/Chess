...
void Chess::move(string posit, string step) {
    ...
    if (posit.size() > 2 && step.size() > 2) {
        ...
        for (int i = 0; i < general_poss_st(board, -1).size(); i++) {
            if (general_poss_st(board, -1)[i][1].size() == 4 && general_poss_st(board, -1)[i][0][0] == a && general_poss_st(board, -1)[i][0][1] == b
                && general_poss_st(board, -1)[i][1][0] == x && general_poss_st(board, -1)[i][1][1] == y
                && general_poss_st(board, -1)[i][1][2] == c && general_poss_st(board, -1)[i][1][3] == d
                && general_poss_st(board, -1)[i][1][4] == z && general_poss_st(board, -1)[i][1][5] == j) {
                t = true;
                break;
            }
        }
        ...
        for (int i = 0; i < general_poss_st(board, -1).size(); i++) {
            if (general_poss_st(board, -1)[i][1].size() == 2 && general_poss_st(board, -1)[i][0][0] == a && general_poss_st(board, -1)[i][0][1] == b
                && general_poss_st(board, -1)[i][1][0] == x && general_poss_st(board, -1)[i][1][1] == y) {
                t = true;
                break;
            }
    ...
    if (general_poss_st(board, 1)[m][1].size() == 2) {
        ...
        c = general_poss_st(board, 1)[m][1][2];
        d = general_poss_st(board, 1)[m][1][3];
        z = general_poss_st(board, 1)[m][1][4];
        j = general_poss_st(board, 1)[m][1][5];
